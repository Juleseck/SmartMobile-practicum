...
class TableViewController: UITableViewController {
    ...
    func parseJsonData(_ jsonObject: Array<AnyObject>) {
        for item in jsonObject {
            let pirate = Pirate(name: item["name"] as! String, life: item["life"] as! String, yearsActive: item["years_active"] as! String, countryOfOrigin: item["country_of_origin"] as! String, comments: item["comments"] as! String)
